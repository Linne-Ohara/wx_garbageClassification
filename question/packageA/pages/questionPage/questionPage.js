...
Page({
  ...
  tapRadio: function (e) {
    ...
    console.log(this.data.swiper.active)
    ...
    if (this.data.answers.activeNum + 1 < this.data.answers.allList.length) {
      ...
      if (num > 0) {
        ...
        wx.showModal({
          ...
          success: function (res) {
            if (res.confirm) {
              that.data.answers.allList = copy(questionData.data)
   ...
   // console.log()
    ...
    if (this.$isLock) {
      this.isLockCall = function () {
        ...
        this.data.answers.allList = copy(questionData.data)
        this.data.isLoading = false
        this.data.isFirst = true
        this.setData(this.data)
      }
